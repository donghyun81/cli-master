...
#   invariants across 5-repo), surface a warning so cli session escalates to a
...
BLOCK_REASON="Protected file edit blocked: ${PROTECTED_REL}. Protected files require a master cycle (see .claude/rules/cycle-discipline.md §3 + §10) — direct edit bypasses 5-repo byte-identical invariants."
