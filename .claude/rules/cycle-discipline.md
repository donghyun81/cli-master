...
- **보호 파일 5종 (강제)**: `docs/schemas/ui-spec.schema.json` · `.claude/rules/pencil-uiux-workflow.md` · `docs/design/pencil-sot-policy.md` · `.claude/rules/uiux-sot-refresh.md` · `docs/design/design-sot-policy.md` — drift = 즉시 mitigation (리뷰 블로커).
...
- **23** Recommended option disk verification = [`disk-verification` skill](../skills/disk-verification/SKILL.md) (경유 `recommended-option-disk-verification.md` · §17 실측 표준 흡수)
- **24** Runtime crash mitigation = [`runtime-crash-mitigation` skill](../skills/runtime-crash-mitigation/SKILL.md) (9-step · staging 한정)
- **25** INITIATIVES + INDEX + task file auto-sync = [`initiatives-sync` skill](../skills/initiatives-sync/SKILL.md) (5 의무 영역 = skill §3 · ④ KR gate + ⑤ always-fresh)
- **26** Paste source authoring disk 실측 = [`paste-source-authoring` skill](../skills/paste-source-authoring/SKILL.md)
- **27** Anchor list = [`anchor-list.md`](./anchor-list.md) (10 anchor hot · negative space line = `reporting.md` §13)
...
> 변경 정책 = [`rule-footer-common.md`](./rule-footer-common.md). 2026-07-10 · MASTER-CLI-CONTEXT-DIET-2-001 T1 · 본 file diet (49.4K → hot 실행 규약 · 원문 전문 = COLD verbatim snapshot · 정보 소실 0).
