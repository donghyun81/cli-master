...
4. 6-repo propagation (`scripts/propagate.sh .claude/rules/terminology.md --targets all`)
...
본 file = cli infra 권장 byte-identical (6-repo · master + app-foundation + GentlyBreath + GentlyDay + GentlyTable + gently-product-docs).
