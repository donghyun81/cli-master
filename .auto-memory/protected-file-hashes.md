...
| `.claude/rules/uiux-sot-refresh.md` | 도구 무관 (95% generic) | `75c0c47ee29993ae57a81b3060bd2b2c5f447e0b0fcb0f55a32feeee4d0ddca1` | **MASTER-CLI-PROTECTED-STALE-PATH-FIX-001 갱신** (2026-06-10 · :27 lineage 계약 조항 폐기 + :61 repo-config 경로 `scripts/agent/`→`scripts/` 정정 · 본문 sha 변동 · 이전 `ee377dc2ac32…`) · 직전 MASTER-PROTECTED-BASELINE-RESYNC-001 (2026-05-03 · baseline 정합) |
...
| `.claude/rules/pencil-uiux-workflow.md` | Pencil 도구 바인딩 (30% 잔존) | `52c075767388b36f7ea7611ec77cb6c861b62ce67fb92992cd36fa6a7e2a912f` | **MASTER-CLI-PROTECTED-STALE-PATH-FIX-001 갱신** (2026-06-10 · :12 `save-as-result-check.sh` 경로 `.claude/hooks/`→`scripts/` stale 정정 · 본문 sha 변동 origin · 이전 `e6a4a2a1457b…`) · 직전 MASTER-CLI-PENCIL-UIUX-HEADLESS-RESTRUCTURE-001 (2026-05-31 · headless 평문-JSON = .pen 변형 기본 경로 위계 §2.5 신설 + §9 승격 + stale 2.1.114 pin 2 줄 정정 · 본문 sha 변동 origin · 이전 `d64481370d...`) · 직전 MASTER-CLI-PENCIL-RECOLOR-GENERATOR-001 (2026-05-31 · §9.4 Recolor sub-flow 신설) · MASTER-CLI-PENCIL-OPTIMIZATION-001 (2026-05-19 · §1 도구 정정 + §9 Pencil CLI binding 신설) |
