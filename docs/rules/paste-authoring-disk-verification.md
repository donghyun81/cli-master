...
> **본문 단일 SoT** = [`.claude/skills/paste-source-authoring/SKILL.md`](../../.claude/skills/paste-source-authoring/SKILL.md)
>
...
>
> 본문 본질 = `.claude/skills/paste-source-authoring/SKILL.md` 측 SKILL.md body 단일 default (= 직전 본 file 측 215 lines 본문 본질 보존 default · skill body 측 frontmatter `name` + `description` + `paths` + `allowed-tools` 추가 default).
>
