...
3. `docs/rules/domain-roles.md` 의 agent→domain/rule 소유 매트릭스 갱신 (= 직전 `docs/agent/solutions/README.md` 역할표 흡수 · 부재 file · MASTER-CLI-AGENT-ROLE-MATRIX-001)
...
- 2026-05-02 · `C1-MASTER-BOOTSTRAP-001` · 본 rule 신설 (= 239 행 · `ff65723`).
