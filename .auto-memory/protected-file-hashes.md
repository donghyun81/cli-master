...
| `.claude/rules/pencil-uiux-workflow.md` | Pencil 도구 바인딩 (30% 잔존) | `d64481370d700109b97f61800d68784c912c1288f61bb6a38911a8d498b93072` | **MASTER-CLI-PENCIL-RECOLOR-GENERATOR-001 갱신** (2026-05-31 · §9.4 Recolor sub-flow 신설 · headless gray-trap → brand remap 경로 · 본문 sha 변동 origin · 이전 `f1825013...`) · 직전 MASTER-CLI-PENCIL-OPTIMIZATION-001 (2026-05-19 · §1 12 official + 1 pkg 도구 정정 + §9 Pencil CLI binding 신설) · MASTER-CLI-PROTECTED-FILE-HASH-CONVENTION-001 resync (2026-05-30 · stale `7621013e...` 정정) |
