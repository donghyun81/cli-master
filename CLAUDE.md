...
## 14a. 보호 파일 sha baseline (2026-06-10 · MASTER-CLI-PROTECTED-STALE-PATH-FIX-001 마감 · git-sha1)

5종 보호 파일 git-sha1 (= `git hash-object` · post-cycle baseline · 본 cycle 안 `.claude/rules/pencil-uiux-workflow.md` + `.claude/rules/uiux-sot-refresh.md` 2 file 변경):

| 보호 파일 | git-sha1 | 본 cycle 변동 |
|---|---|---|
| `docs/schemas/ui-spec.schema.json` | `5b84cd9e4bc361652d6d0e561d8846eed3400d00` | 불변 |
| `.claude/rules/pencil-uiux-workflow.md` | `bac8e80151b9dee8090612dc7bfbe141e67862dc` | **갱신** (이전 `9d47624a...` · :12 `save-as-result-check.sh` 경로 `.claude/hooks/`→`scripts/` stale 정정) |
| `docs/design/pencil-sot-policy.md` | `b27fbe16edb688218d7e57dd9a66d0f2a31ef300` | 불변 |
| `.claude/rules/uiux-sot-refresh.md` | `b9a0c584b3c5a3f16c7c5e17de807f5e31b92c52` | **갱신** (이전 `d3a0b573...` · :27 lineage 계약 조항 폐기 + :61 repo-config 경로 `scripts/agent/`→`scripts/` 정정) |
| `docs/design/design-sot-policy.md` | `e580b6d7ca9a88aef67c03f4bb39360993ab996f` | 불변 |

> **algorithm 분기 주의** (`protected-file-hashes.md §CONVENTION` 정합): 본 §14a = **git-sha1 (40 char)** · `.auto-memory/protected-file-hashes.md` manifest + `.ai/baseline-snapshot/latest.json` = **sha-256 (64 char)**. pencil-uiux-workflow.md 측 sha-256 = `52c075767388b36f7ea7611ec77cb6c861b62ce67fb92992cd36fa6a7e2a912f` (= manifest 측 baseline). 두 algorithm 직접 비교 금지.
