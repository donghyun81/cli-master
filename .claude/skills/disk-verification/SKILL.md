...
| ⑥ | **발주 필수 요건 5칸 자기 검사** (= 발행 전 · 1 칸 부재 = 발주 미완) | 발주서 반려(저작 층 게이트) |
...
**⑥ 세부** (= 신 발주 필수 요건 5칸 · 발행 **전** 자기 검사 · 원칙 층 SoT = [`code-principles.md`](../../../docs/rules/code-principles.md) §0.3):
...
\+ **판 경계 1줄** — 이 판의 경계가 **왜 여기인가**. ★**「작아서」가 이유이면 판을 다시 잡는다**(= 범위 축소가 기본값이 아니다).
