...
description: Use after a child cycle REVIEW PASS to sync docs/release-readiness/INITIATIVES.md + .ai/tasks/INDEX.md + .ai/tasks/<CYCLE-ID>.md before paste-back emission. Enforces the 3-file update obligation. Trigger-based paradigm — not invoked every cycle, only on child cycle REVIEW PASS or catch-up cycle entry. Touches docs/release-readiness/INITIATIVES.md and .ai/tasks/**.
...
## 부록 (= §8 paste 구조 + §9 commit body + §10 인접 paradigm · §12 cycle 이력)
