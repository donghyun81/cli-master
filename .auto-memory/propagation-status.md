...
| `docs/rules/workflow-core.md` | `f6ff5e09bca4` | ✓ | ✓ | ✓ |
| `docs/rules/cycle-discipline.md` | `ab788f448192` | ✓ | ✓ | ✓ |
| `docs/rules/pencil-automation.md` | `a2506a34d797` | ✓ | ✓ | ✓ |
| `docs/rules/reporting.md` | `85b70b0c0d13` | ✓ | ✓ | ✓ |
| `docs/rules/routing-and-delegation.md` | `f728c6b08bf3` | ✓ | ✓ | ✓ |
| `docs/rules/deferred-domains.md` | `9952cb6074c6` | ✓ | ✓ | ✓ |
| `docs/rules/code-principles.md` | `2e21249973e6` | ✓ | ✓ | ✓ |
| `docs/rules/design-to-code-sync.md` | `fe29cb7d1664` | ✓ | ✓ | ✓ |
| `docs/rules/ux-laws.md` | `3bc9a89a4c36` | ✓ | ✓ | ✓ |
...
- timestamp: 2026-08-30T21:29:22+0900
- pass: 161
- drift: 0
- miss: 0
- exit: 0
